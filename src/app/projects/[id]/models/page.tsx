  ...
  return (
    <div style={{ background: "#050508", minHeight: "calc(100vh - 64px)" }}>
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <h1 className="text-xl font-bold mb-2" style={{ color: "#eee" }}>{L.models}</h1>
        <p className="text-sm mb-8" style={{ color: "#555" }}>{L.modelsSub}</p>
        <div className="p-8 rounded-2xl text-center"
          style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
          <div className="text-4xl mb-3">◈</div>
          <p className="text-sm" style={{ color: "#444" }}>{L.modelsComing}</p>
        </div>
      </div>
    </div>
  );
