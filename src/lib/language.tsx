...
export const COPY = {
  en: {
    ...
    sidebar: { ideas: "Ideas", models: "Models", draft: "Draft", inProgress: "In Progress", ready: "Ready to Print", mold: "Mold Stage", orders: "Orders", cart: "Cart", wishlist: "Wishlist", ordered: "Ordered", received: "Received", printers: "Printers", findPrinters: "Find Printers", becomePrinter: "Become a Printer", wallet: "Wallet", balance: "Balance", withdraw: "Withdraw", history: "History", projectsHeader: "Projects", myCreated: "Created by me", myJoined: "Joined", noProjects: "No projects yet", projectPlaza: "Project Plaza / New", overview: "Overview", discussion: "Discussion", tasks: "Tasks", modelVersions: "Model Versions", milestones: "Milestones", members: "Members" },
