...
export const COPY = {
  en: {
    ...
    sidebar: { ideas: "Ideas", models: "Models", draft: "Draft", inProgress: "In Progress", ready: "Ready to Print", mold: "Production", upload: "Upload", orders: "Orders", cart: "Cart", wishlist: "Wishlist", ordered: "Ordered", received: "Received", printers: "Printers", findPrinters: "Find Printers", becomePrinter: "Become a Printer", wallet: "Wallet", balance: "Balance", withdraw: "Withdraw", history: "History", projectsHeader: "Projects", myCreated: "Created by me", myJoined: "Joined", noProjects: "No projects yet", projectPlaza: "Project Plaza / New", overview: "Overview", discussion: "Discussion", tasks: "Tasks", modelVersions: "Model Versions", milestones: "Milestones", members: "Members" },
  ...
  zh: {
    ...
    sidebar: { ideas: "想法", models: "模型", draft: "草稿", inProgress: "进行中", ready: "待打印", mold: "量产", upload: "上传", orders: "订单", cart: "购物车", wishlist: "收藏", ordered: "已下单", received: "已收货", printers: "打印终端", findPrinters: "寻找打印机", becomePrinter: "成为打印终端", wallet: "钱包", balance: "余额", withdraw: "提现", history: "记录", projectsHeader: "项目", myCreated: "我创建的", myJoined: "我参与的", noProjects: "暂无项目", projectPlaza: "项目广场 / 新建", overview: "概览", discussion: "讨论", tasks: "任务", modelVersions: "模型版本", milestones: "里程碑", members: "成员" },
